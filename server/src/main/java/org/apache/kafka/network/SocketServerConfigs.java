...
public class SocketServerConfigs {
    ...
    public static final int BOOSTER_GLOBAL_REASSIGN_COOLDOWN_TICKS_DEFAULT = 10;
    public static final String BOOSTER_GLOBAL_REASSIGN_COOLDOWN_TICKS_DOC = "The number of check cycles (ticks) that must elapse after any of channel reassignment before manager conducts reassignment again. This cooldown period ensures the channel has sufficient time to accumulate fresh performance statistics while running in the reassigned path.";

    public static final String BOOSTER_CHANNEL_REASSIGN_COOLDOWN_TICKS_CONFIG = "booster.channel.reassign.cooldown.ticks";
    public static final int BOOSTER_CHANNEL_REASSIGN_COOLDOWN_TICKS_DEFAULT = 100;
    public static final String BOOSTER_REASSIGN_COOLDOWN_TICKS_DOC = "The minimum number of check cycles (ticks) a channel must remain in the booster path or normal path after reassignment. This cooldown period prevents rapid toggling (thrashing) of channels between dedicated and standard processing paths.";
    ...
    public static final ConfigDef CONFIG_DEF =  new ConfigDef()
            ...
            .define(BOOSTER_GLOBAL_REASSIGN_COOLDOWN_TICKS_CONFIG, INT,
                BOOSTER_GLOBAL_REASSIGN_COOLDOWN_TICKS_DEFAULT, atLeast(0), MEDIUM,
                BOOSTER_GLOBAL_REASSIGN_COOLDOWN_TICKS_DOC)
            .define(BOOSTER_CHANNEL_REASSIGN_COOLDOWN_TICKS_CONFIG, INT,
                BOOSTER_CHANNEL_REASSIGN_COOLDOWN_TICKS_DEFAULT, atLeast(0), MEDIUM,
                BOOSTER_REASSIGN_COOLDOWN_TICKS_DOC)
